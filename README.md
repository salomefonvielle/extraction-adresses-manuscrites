# Extraction d'adresses depuis des documents PDF (projet en cours) 
...
Le docuement à traiter est un csv contenant par ligne l'identité d'une personne et l'identifiant du document pdf contenant son adresse. L'objectif est d'extraire l'adresse de ce document. 

## Trois pipelines comparées

| Pipeline | OCR | Extraction | Durée / doc | Qualité / Coût | Résultat |
|---|---|---|---|---|---|
| `tesseract_llm` | Tesseract | LLM (Gpt-oss-120b) | ~1m | Rapide, peu coûteux | ❌ Exclu |
...
### Résultats des tests (2 documents, l'industrialisation pour test sur 17 000 docuements est en cours)
